    ...
    return (
        <div className="container mx-auto w-screen h-screen">
            ...
            <div className="box-content h-64 w-64 p-4 border-4 border-green-100 shadow-2xl flex justify-center  m-20 md:m-32 flex-col relative space-y-6 bg-purple-50" >
                <span className="block bg-green-400 flex-col  inset-x-0 top-0 m-5 rounded-full h-24 w-24 flex items-center justify-center ">Enter your id</span>
                <input  className="block flex-col focus:outline-none focus:ring focus:border-green-100 relative m-1 " ref={idRef} placeholder="enter here"></input>
