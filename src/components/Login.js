    ...
    return (
        ...
        <div className="container mx-auto w-screen h-screen bg-gray-300 ">
            ...
            <form onSubmit={handleSubmit} className="box-content h-64 w-64 p-4 border-4 border-green-100 shadow-2xl flex justify-center  m-20 md:m-32 flex-col relative space-y-6 bg-purple-50" >
                ...
                <input type="text"  className="block flex-col focus:outline-black focus:ring focus:border-green-100 relative m-1 placeholder-opacity-100 " ref={idRef} required placeholder="enter username here"></input>
                ...
                <button onClick={createNewId}   className="flex flex-col bg-green-400 m-1 rounded-full py-3 px-6 animate-bounce  transition duration-500 ease-in-out bg-green-400 hover:bg-purple-200 transform hover:-translate-y-1 hover:scale-110 ">create new username</button>
